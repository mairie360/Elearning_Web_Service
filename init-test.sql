-- Seed minimal pour les tests isolés (performance / sécurité) du front Elearning.
...
-- (sinon 502 côté BFF User, que BFF_Elearning appelle pour résoudre la session des routes /elearning/*).
